...
In evaluating those designs that I was able to come up with, I decided to pick the "power ranking" interface.
As a reminder, the purpose of this component is to create a ulility that allows the user to create "power
rankings" of the best teams in a given sport. In narrowing down the three designs I came up with,
I attempted to root out those designs that I had less passion for - as, knowing myself, the quality
of the work I do is usually correllated at least to some extent with how much passion I have for
what I'm working on. Additionally, I took the timeframe in which we are working
with this project into consideration, trying to find the design that
fulfills my previously mentioned "passion" requirement while also remaining realistic to complete within the given timeframe. Finally, I took the ease of testing into consideration as well.
Given these requirements, I narrowed my options down to the "power ranking" interface. All three interfaces
that I proposed, I concluded, would likely be able to be completed within the given timeframe, and would be equally as
difficult to test, and so ultimately
my choice came down to each component's ability
to meet the passion requirement. Ultimately, I chose the "power ranking" interface seeing as though I am interested in sports and thus would likely be
more passionate about implementing an interface involving sports than the other
two proposed interfaces.
